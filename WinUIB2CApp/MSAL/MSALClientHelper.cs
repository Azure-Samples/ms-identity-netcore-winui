...
namespace WinUIMSALAppB2C.MSAL
{
    ...
    public class MSALClientHelper
    {
        ...
        /// </summary>
        public readonly AzureADB2CConfig AzureADB2CConfig;
        ...
        {
            this.AzureADB2CConfig = azureADB2CConfig;

            this.InitializePublicClientApplicationBuilder();
        }

        /// <summary>
        /// Initializes the MSAL's PublicClientApplication builder.
        /// </summary>
        /// <autogeneratedoc />
        ...
        public async Task<IAccount> InitializePublicClientB2CAppAsync(IntPtr? handle)
        {
        ...
        private async Task<IEnumerable<IAccount>> AttachTokenCache()
        {
            ...
            var storageProperties = new StorageCreationPropertiesBuilder(AzureADB2CConfig.CacheFileName, AzureADB2CConfig.CacheDir).Build();
    ...
    /// <param name="extraclaims">The extra claims, usually from CAE. We basically handle CAE by sending the user back to Azure AD for additional processing and requesting a new access token</param>
        /// <returns></returns>
        ...
        private async Task<AuthenticationResult> SignInUserInteractivelyAsync(string[] scopes, IAccount existingAccount = null)
        {
            ...
            if (this.PublicClientApplication.IsUserInteractive())
            {
                return await this.PublicClientApplication.AcquireTokenInteractive(scopes)
                    ...
                    .WithParentActivityOrWindow(windowHandle) // TODO: fix it
                    .ExecuteAsync()
                    .ConfigureAwait(false);
            }
