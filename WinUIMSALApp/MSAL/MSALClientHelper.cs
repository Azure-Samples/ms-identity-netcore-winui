...
namespace WinUIMSALApp.MSAL
{
    ...
    public class MSALClientHelper
    {
        ...
        {
            this.PublicClientApplicationBuilder = PublicClientApplicationBuilder.Create("YOUR_CLIENT_ID")
                .WithExperimentalFeatures() // this is for upcoming logger
                .WithB2CAuthority($"{"YOUR_B2C_INSTANCE e.g. https://<YOUR-DOMAIN>.b2clogin.com"}/tfp/{"YOUR_B2C_DOMAIN e.g. <YOUR-DOMAIN>.onmicrosoft.com"}/{"YOUR SIGN-UP/SIGN-OUT POLICY. e.g. b2c_susi"}")
                ...
                .WithRedirectUri($"msal[REPLACE_WITH_YOUR_CLIENT_ID]://auth");
        }
